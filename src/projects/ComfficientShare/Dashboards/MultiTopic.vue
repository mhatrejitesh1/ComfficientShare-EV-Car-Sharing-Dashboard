    ...
    data() {
        return {
            ...
            viewSetup: [
                ...
                { title: "Öffentliche Straßen", map: "ComfficientShare/streets", template: "ComfficientShare/streets" },
                { title: "Aktive Mobilität", map: "ComfficientShare/points", template: "ComfficientShare/poi" },
            ]
        }
    },
    methods: {
